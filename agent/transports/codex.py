    ...
    def build_kwargs(
        ...
        **params,
        ...
        params:
            ...
            openai_encrypted_reasoning_ok: bool — False when targeting direct
                OpenAI with a model that rejects
                ``include: ["reasoning.encrypted_content"]`` (GPT-4.x).
                Defaults to True for other backends.
        """
        ...
        if reasoning_enabled and is_xai_responses:
            ...
            elif params.get("openai_encrypted_reasoning_ok", True):
                kwargs["reasoning"] = {"effort": reasoning_effort, "summary": "auto"}
                kwargs["include"] = (
                    ["reasoning.encrypted_content"] if replay_encrypted_reasoning else []
                )
            # else: direct OpenAI + non-GPT-5 model — omit reasoning/include
            # entirely. GPT-4.x rejects ``include: ["reasoning.encrypted_content"]``,
            # and reasoning params don't apply to non-reasoning models anyway.
