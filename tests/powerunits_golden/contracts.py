...
def args_for(contract: BoundedHttpContract) -> dict[str, Any]:
    ...
    if style == "db_health":
        return {"limit": 10, **contract.extra_happy_args}
...
BOUNDED_HTTP_CONTRACTS: tuple[BoundedHttpContract, ...] = (
    ...
    BoundedHttpContract(
        ...
        "tools.powerunits_db_health_read_tool",
        "read_powerunits_db_health_storage_v1",
        "/internal/hermes/bounded/v1/db-health/storage",
        ("HERMES_POWERUNITS_DB_HEALTH_READ_ENABLED",),
        "db_health",
        "READ",
        False,
        "feature_disabled",
    ...
    BoundedHttpContract(
        ...
        "tools.powerunits_db_health_read_tool",
        "read_powerunits_db_health_planner_v1",
        "/internal/hermes/bounded/v1/db-health/planner",
        ("HERMES_POWERUNITS_DB_HEALTH_READ_ENABLED",),
        "db_health",
        "READ",
        False,
    ...
    BoundedHttpContract(
        ...
        "tools.powerunits_db_health_read_tool",
        "read_powerunits_db_health_indexes_v1",
        "/internal/hermes/bounded/v1/db-health/indexes",
        ("HERMES_POWERUNITS_DB_HEALTH_READ_ENABLED",),
        "db_health",
        "READ",
        False,
    ...
    BoundedHttpContract(
        ...
        "tools.powerunits_db_health_read_tool",
        "read_powerunits_db_health_vacuum_v1",
        "/internal/hermes/bounded/v1/db-health/vacuum",
        ("HERMES_POWERUNITS_DB_HEALTH_READ_ENABLED",),
        "db_health",
        "READ",
        False,
    ...
    BoundedHttpContract(
        ...
        "tools.powerunits_db_health_read_tool",
        "read_powerunits_db_health_sessions_v1",
        "/internal/hermes/bounded/v1/db-health/sessions",
        ("HERMES_POWERUNITS_DB_HEALTH_READ_ENABLED",),
        "db_health",
        "READ",
        False,
    ...
    BoundedHttpContract(
        ...
        "tools.powerunits_db_health_read_tool",
        "read_powerunits_db_health_statements_v1",
        "/internal/hermes/bounded/v1/db-health/statements",
        ("HERMES_POWERUNITS_DB_HEALTH_READ_ENABLED",),
        "db_health",
        "READ",
        False,
    ...
    BoundedHttpContract(
        ...
        "tools.powerunits_db_health_read_tool",
        "read_powerunits_timescale_observe_v1",
        "/internal/hermes/bounded/v1/db-health/timescale",
        ("HERMES_POWERUNITS_DB_HEALTH_READ_ENABLED",),
        "db_health",
        "READ",
        False,
