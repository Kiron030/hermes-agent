...
class AIAgent:
    ...
    def __init__(
        ...
        # ``include: ["reasoning.encrypted_content"]``. ACP runtimes are
        # excluded: CopilotACPClient handles its own routing and does not
        # implement the Responses API surface.
    ...
    def _build_api_kwargs(self, api_messages: list) -> dict:
        ...
        if self.api_mode == "codex_responses":
            ...
            return _ct.build_kwargs(
                ...
                openai_encrypted_reasoning_ok=openai_encrypted_reasoning_ok,
            )
