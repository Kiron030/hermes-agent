...
**Operator / stage docs (Powerunits):** `SOUL.hermes.md` (Stage 1 Trusted Analyst profile), `RUNBOOK.hermes-trusted-analyst.md`, `ACCESS_MATRIX.md`, `RUNBOOK.hermes-stage1-validation.md` (post-deploy checks), `docs/powerunits_hermes_progressive_posture_v1.md` (**canonical staged roadmap**, Phase 0 + tier1 Phase 1A/1B), `docs/powerunits_operator_posture_diagnostics_v1.md` (Phase 1B posture tool reference), `docs/powerunits_timescale_read_operator_v1.md`, `docs/powerunits_repo_b_read_operator_v1.md` (Repo B read prep — **no live tool yet**), `config/powerunits_repo_b_read_allowlist.json`. **Stage 2 (documentation only, not live):** `SOUL.hermes-writer.md`, `RUNBOOK.hermes-writer.md`, `CHECKLIST.hermes-writer-activation.md` (mandatory gate before any future enable).
