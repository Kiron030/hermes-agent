...
TOOLSETS = {
    ...
    "powerunits_tier4b_review_governance": {
        "description": (
            "Tier 4B (tier>=5): governance/ + draft review_status only. Routing: "
            "manifest_powerunits_tier4b_governance_scope (NOT Tier 4A manifest), "
            "list_powerunits_governance_workspace (NOT list_hermes_workspace), "
            "summarize_powerunits_tier4b_governance_lane (NOT ERA5/summary bounded tools), "
            "append_powerunits_governance_note (NOT save_hermes_workspace_note). "
    ...
    "powerunits_entsoe_market_bounded_preflight": {
        "description": (
            "Bounded ENTSO-E market sync **preflight** (Repo B Tier-1 ISO2 **DE/NL/BE/FR/AT/CZ/PL/FI** / v1 / ≤7d UTC): local slice check only; "
    ...
    "powerunits_entsoe_market_bounded_execute": {
        "description": (
            ...
            "(Repo B Tier‑v1 mirrored ISO2 bundle (**`DE`/`NL`/`BE`/`FR`/`AT`** — Hermes ≡ Repo B frozenset) / v1 / ≤7 d). "
            "**Primary:** `HERMES_POWERUNITS_ENTSOE_MARKET_BOUNDED_ENABLED` (+ optional "
    ...
    "powerunits_entsoe_market_bounded_validate": {
        "description": (
            ...
            "(Repo B Tier‑v1 mirrored ISO2 **`DE`/`NL`/`BE`/`FR`/`AT`** / **`v1`** / ≤7 d). "
    ...
    "powerunits_entsoe_market_bounded_campaign": {
        "description": (
            "Bounded ENTSO-E market sync **campaign v1** (mirrored Tier‑v1 **`DE`/`NL`/`BE`/`FR`/`AT`** bundle; `_de` suffix is historical): "
    ...
    "powerunits_entsoe_market_bounded_coverage_scan": {
        "description": (
            "Bounded ENTSO-E market sync **coverage-scan** (read-only, **`v1`**, mirrored Tier‑v1 **`DE`/`NL`/`BE`/`FR`/`AT`**): one HTTP POST to "
    ...
    "powerunits_entsoe_forecast_bounded_validate": {
        "description": (
            ...
            "`/internal/hermes/bounded/v1/entsoe-forecast/validate-window` (Repo B Tier-1 ISO2 **DE/NL/BE/FR/AT/CZ/PL/FI** / v1 / ≤7 d). "
    ...
    "hermes-yuanbao": {
        "description": "Yuanbao bot toolset - full access (terminal has safety checks via dangerous command approval)",
        "tools": _HERMES_CORE_TOOLS + [
            "yb_query_group_info",
            "yb_query_group_members",
            "yb_send_dm",
