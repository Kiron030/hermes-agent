"""
Local slice validation for bounded **outage awareness** Hermes tools (DE / v1 / ≤7d).

Read-only Repo B endpoints only — no registry.register.
"""
...
def validate_outage_awareness_bounded_slice(
    country: str,
    start_s: str,
    end_s: str,
    version: str,
    ...
    if cc != "DE":
        raise ValueError("country must be DE for bounded outage awareness v1")
