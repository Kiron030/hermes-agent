"""Local slice validation for bounded **outage repair** Hermes execute (DE / v1 / ≤7d).

Matches Repo B bounded outage repair v1 constraints.
"""
...
def validate_outage_repair_bounded_slice(
    country: str,
    start_s: str,
    end_s: str,
    version: str,
    ...
    if cc != "DE":
        raise ValueError("country must be DE for bounded outage repair v1")
