...
def validate_entsoe_bounded_slice(
    country: str,
    start_s: str,
    end_s: str,
    version: str,
...
def plan_entsoe_bounded_campaign_windows(
    start: datetime,
    end: datetime,
...
def validate_entsoe_bounded_campaign(
    country: str,
    ...
    windows = plan_entsoe_bounded_campaign_windows(start, end)
