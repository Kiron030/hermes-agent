...
| `docs/powerunits_hermes_progressive_posture_v1.md` | **Single canonical staged-liberation roadmap** (Phase 0–2B + **Tier 3** skills observer); rollback / watcher; **`HERMES_POWERUNITS_CAPABILITY_TIER`**. |
...
| `docs/powerunits_operator_posture_diagnostics_v1.md` | Phase 1B read-only **`summarize_powerunits_operator_posture`** (JSON semantics, watcher rollup, **2A / 2B / Tier 3** Telegram drift flags). |
