...
| `docs/powerunits_operator_posture_diagnostics_v1.md` | Phase 1B read-only **`summarize_powerunits_operator_posture`** (JSON semantics, watcher rollup). |
...
- [ ] **Phase 1B operator posture snapshot (optional):** **`summarize_powerunits_operator_posture`** → **`read_only: true`**; review **`caution_flags`** + env fingerprint per [`docs/powerunits_operator_posture_diagnostics_v1.md`](docs/powerunits_operator_posture_diagnostics_v1.md).
