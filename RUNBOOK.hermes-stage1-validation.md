...
| `docs/powerunits_hermes_progressive_posture_v1.md` | **Single canonical staged-liberation roadmap** (Phase 0 + **Phase 1A** exports slice); rollback / watcher; optional **`HERMES_POWERUNITS_CAPABILITY_TIER`**. |
