...
#
# Powerunits note: the gosu-based privilege drop + first_safe_v1 runtime
# policy hook + skill-sync gating that used to live in this file were
# ported to docker/stage2-hook.sh (the new s6-overlay bootstrap
# equivalent) as part of the v0.15.0 sync — see that file for the
# HERMES_POWERUNITS_RUNTIME_POLICY handling.
#
