...
**Doc set (Stage 1):** `SOUL.hermes.md` · `ACCESS_MATRIX.md` · **this runbook** · `RUNBOOK.hermes-stage1-validation.md` (repeatable checks + post-deploy verification).
...
5. **BZN day-ahead prices (bounded read):** with **`HERMES_POWERUNITS_ENTSOE_BZN_PRICES_READ_ENABLED`**, Telegram may call **`read_powerunits_entsoe_bzn_prices_v1`** → Repo B **`POST …/entsoe-bzn-prices/read`** (actual EUR/MWh rows; **not** readiness; **not** Tier‑v1 promotion). Recorded smoke parameters and response fields: **`RUNBOOK.hermes-stage1-validation.md`** → *Recorded Telegram smoke*.
