...
- **Repo B Tier‑1 ISO2 (bounded v1, same HTTP routes):** **DE, NL, BE, FR, AT, CZ, PL** for both **market** (`…/entsoe-market-sync/*`) and **forecast** (`…/entsoe-forecast/*`). **ES / IT / SE** remain off the bounded v1 allowlist until a separate rollout.
